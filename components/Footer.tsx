...
const Footer: React.FC<FooterProps> = ({ onOpenAdmin, schoolProfile }) => {
  return (
    <footer id="kontak" className="bg-[#022c22] text-slate-300 pt-16 pb-8 relative overflow-hidden font-body">
      ...
      <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
                <div className="flex items-start gap-4">
                    ...
                    <div className="shrink-0 bg-white/5 p-2 rounded-2xl border border-white/10">
                        {schoolProfile.logo ? (
                            <img src={schoolProfile.logo} alt="Logo Sekolah" className="w-14 h-14 object-contain" />
                        ) : (
                            <div className="w-14 h-14 rounded-xl bg-brand-primary flex items-center justify-center text-white font-bold text-xl">
                    ...
                    <div>
                        <h3 className="font-display font-bold text-xl md:text-2xl text-white leading-tight mb-2">
                            {schoolProfile.name}
                        </h3>
                        {/* Secondary Logos Row */}
                ...
                <div className="flex gap-3">
                    <a href={schoolProfile.socialMedia.facebook} target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-all">
                    ...
                    <a href={schoolProfile.socialMedia.instagram} target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#E4405F] hover:border-[#E4405F] hover:text-white transition-all">
                    ...
                    <a href={schoolProfile.socialMedia.youtube} target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#FF0000] hover:border-[#FF0000] hover:text-white transition-all">
                        <svg fill="currentColor" viewBox="0 0 24 24" className="w-4 h-4"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
                    </a>
                </div>
            </div>

            {/* Column 2: Navigation (Span 3 on LG) */}
            <div className="lg:col-span-3 lg:pl-8 pt-2">
            ...
            <div className="lg:col-span-4 pt-2">
                ...
                <ul className="space-y-4 text-sm">
                    <li className="flex items-start gap-4 group">
                        <div className="w-8 h-8 rounded bg-white/5 flex items-center justify-center text-brand-primary shrink-0 group-hover:bg-brand-primary group-hover:text-white transition-colors">📍</div>
                        <span className="leading-relaxed">{schoolProfile.address}</span>
                    </li>
                    ...
                    <li className="flex items-center gap-4 group">
                        <div className="w-8 h-8 rounded bg-white/5 flex items-center justify-center text-brand-primary shrink-0 group-hover:bg-brand-primary group-hover:text-white transition-colors">✉️</div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
            ...
            <button 
                onClick={onOpenAdmin}
                className="flex items-center gap-2 hover:text-white transition-colors opacity-50 hover:opacity-100 px-3 py-1 rounded hover:bg-white/5"
            >
