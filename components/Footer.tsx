        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 gap-x-8 lg:gap-16">
            ...
            <div className="md:col-span-12 lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
                ...
                <div className="flex items-center gap-3 pt-2">
                    {schoolProfile.socialMedia.facebook && (
                        <a href={schoolProfile.socialMedia.facebook} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-all duration-300 transform hover:-translate-y-1" title="Facebook">
                    ...
                    {schoolProfile.socialMedia.instagram && (
                        <a href={schoolProfile.socialMedia.instagram} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#E4405F] hover:border-[#E4405F] hover:text-white transition-all duration-300 transform hover:-translate-y-1" title="Instagram">
                    ...
                    {schoolProfile.socialMedia.tiktok && (
                        <a href={schoolProfile.socialMedia.tiktok} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-black hover:border-black hover:text-white transition-all duration-300 transform hover:-translate-y-1" title="TikTok">
                           <svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.03 5.91-.05 8.81-.47 9.91-15.86 7.84-14.4-1.7.56-3.7 3.59-6.26 7.18-6.09v4.05c-.56-.16-1.16-.24-1.74-.15-1.6.25-2.81 1.65-2.77 3.28.05 1.63 1.34 3.06 2.96 3.26 1.83.23 3.53-1.07 3.8-2.88.08-.57.06-1.15.06-1.72V0h1.42z"/></svg>
                        </a>
                    )}
                    {schoolProfile.socialMedia.youtube && (
                        <a href={schoolProfile.socialMedia.youtube} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#FF0000] hover:border-[#FF0000] hover:text-white transition-all duration-300 transform hover:-translate-y-1" title="YouTube">
